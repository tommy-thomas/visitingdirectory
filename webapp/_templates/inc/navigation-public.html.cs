			...
			<div id="leftnav" role="navigation">
				<div class="content">
					<ul class="menu">
						...
						<li class=""><a href="https://vc.uchicago.edu/page/about-committees-and-councils">About the ACs</a></li>
						...
						<li class=""><a href="https://vc.uchicago.edu/page/committee-membership" class="active">Council Membership</a>
