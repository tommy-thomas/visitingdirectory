 ...
 */
	class CommitteeMember extends WS_DynamicGetterSetter
	{
		...
		//New
        const DEGREE_FILTER = "LOCAL_IND";
        const ADDRESS_FILTER = "ADDR_PREF_IND";
        const EMPLOYMENT_FILTER = "PRIMARY_EMP_IND ";
        const EMAIL_PREFERRED_FILTER = "PREFERRED_IND";
        const EMAIL_TYPE_FILTER = "EMAIL_TYPE_CODE";
